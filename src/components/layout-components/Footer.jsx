...
export default function Footer() {
	...
	return (
		...
		`}>
			<span className="text-muted">Copyright  &copy;  {`${new Date().getFullYear()}`} <a className="font-weight-semibold" href="https://dr-scent.ge" target='_blank'>{`${APP_NAME}`}</a> All rights reserved.</span>
			<div>
