import { Modal, Form, Input, Button, App, Row, Col, Select, Tooltip, InputNumber, Empty } from "antd";
import { useState, useEffect } from "react";
import Flex from "../../../../components/shared-components/Flex";
import { useDispatch } from "react-redux";
import {  editBranch, getAdminsForClient } from "../../../../store/slices/UsersSlice";
...
const EditBranch = (props) => {
    ...
    const [selectedAdminsId, setSelectedAdminsId] = useState(() => {
        ...
        return admins.length > 0 ? admins.filter(elm => elm.id !== null).map(elm => elm.id) : [];
    });
        ...
        component={<>
            ...
            >
                ...
                <Flex gap={10} justifyContent="flex-end">
                    ...
                    <Button type="primary" loading={isLoading} htmlType="submit">{getTranslation("sidenav.client.Edit")}</Button>
                </Flex>
            </Form>
