...
const EditUnit = (props) => {
    ...
    return (
        <Modal open={visible} onCancel={close} footer={null} title={getTranslation("sidenav.settings.unit.edit_title")}>
            <Form
                name="add unit"
                layout="vertical"
                onFinish={handleSave}
            ...
            >
                ...
                <Flex gap={10} justifyContent="flex-end">
                    ...
                    <Button type="primary" htmlType="submit">{getTranslation("sidenav.settings.unit.Edit")}</Button>
                </Flex>
            </Form>
        </Modal>
    )
