import { Form, Input, Row, Col, Button, Modal, Upload, Card, Select, InputNumber, Radio } from "antd"
...
import { add_product, getProductCategory } from "../../../../store/slices/ProductSlice"
            ...
            component={<>
                ...
                >
                                                ...
                                                >
                                                    <Select
                                                        ...
                                                        onChange={(value) => {
                                                            ...
                                                            setSelectedUnit({ id: selected.id, name: locale === 'ka' ? selected.name_ka : selected.name_en })
                                                        }}
                                                    />
                                                </Form.Item>
                                            </Col>
                    ...
                    <Flex gap={10} justifyContent="flex-end">
                        ...
                        <Button type="primary" htmlType="submit">{getTranslation("sidenav.product.Add")}</Button>
                    </Flex>
                </Form>
            </>}
        />
