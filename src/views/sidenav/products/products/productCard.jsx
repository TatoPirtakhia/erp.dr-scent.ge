    ...
    return (
        ...
        >
            ...
            >
                ...
                {product.price ? <Descriptions.Item label={getTranslation("sidenav.import.price")}> {product.price}</Descriptions.Item> : null}
                {product.total_price ? <Descriptions.Item label={getTranslation("sidenav.import.total_price")}> {product.total_price}</Descriptions.Item> : null}
            </Descriptions>
        </Card>
    );
};
